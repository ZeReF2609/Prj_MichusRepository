...
namespace Michus.DAO
{
    public class ProductoDao
    {
        ...
        public async Task DesactivarProducto(string idProducto)
        {
            using (var connection = new SqlConnection(_connectionString))
        ...
        public async Task ActivarProducto(string idProducto)
        {
            using (var connection = new SqlConnection(_connectionString))
            using (var command = new SqlCommand("sp_ActivarProductos", connection) { CommandType = CommandType.StoredProcedure })
            {
                command.Parameters.AddWithValue("@IdProducto", idProducto);
                await connection.OpenAsync();
                await command.ExecuteNonQueryAsync();
